...
function getDataFromCatalystDataStore(catalystApp, status) {
    return new Promise((resolve, reject) => {
        ...
        catalystApp.zcql().executeZCQLQuery(`Select ${columnName}, ${columnEmail}, ${columnMobileNo}, ${columnStatus}, ${columnFileID}, ${columnRowId}, ${columnFilename} from ${tableName}`).then(queryResponse => {
